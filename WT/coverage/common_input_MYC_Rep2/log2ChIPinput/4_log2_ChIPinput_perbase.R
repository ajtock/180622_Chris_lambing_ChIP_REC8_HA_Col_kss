...
# Usage:
# csmit -m 20G -c 1 "./4_log2_ChIPinput_perbase.R REC8_HA_Rep2_ChIP REC8_MYC_Rep2_input"
...
inDir <- "/home/meiosis/ajt200/analysis/180622_Chris_lambing_ChIP_REC8_HA_Col_kss/WT/coverage/"
outDir <- paste0(inDir,
